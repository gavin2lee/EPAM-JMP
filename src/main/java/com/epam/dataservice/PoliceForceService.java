...
public class PoliceForceService {
	...
	// private static final String POLICE_FORCE_CSV =
	// "src/main/resources/police_force.csv";
	private static final String POLICE_FORCE_CSV = PoliceForceService.class.getClassLoader()
			.getResource("police_force.csv").toString().replaceAll("file:", "");
